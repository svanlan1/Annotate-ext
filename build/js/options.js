...
function loadIndex() {
    ...
    *
    ********************************************************************************************************************************/
		//Buttons to change width of box and pin size
    ...
    /********************************************************************************************************************************
    *
    *	Set the values of each form field and what not on the page
    *
    ********************************************************************************************************************************/	
...
chrome.runtime.onMessage.addListener(
	function(request, sender, sendResponse) {
		if(request.greeting === 'hide_login') {
			$('#login_area').remove();
    		$('#ann-log-msg').html('<a style="font-size: .92rem;" class="small black-text" href="http://annotate.tech/home.php" target="_blank">' + localStorage.getItem('userEmail') + '</a> | <a href="javascript:void(0);" style="font-size: .92rem;" class="small black-text" id="logout">Logout</a>');			
		}
	});
